...
const DoctorList = () => {
  ...
  return (
    <div className='m-5 max-h-[90vh] overflow-y-scroll'>
      <h1 className='mb-8 text-3xl font-bold text-gray-800'>All Doctors</h1>
      <div className='flex flex-wrap w-full gap-4 pt-5 gap-y-6'>
        {
          doctors.map((item, index) => (
            <div className='overflow-hidden border border-indigo-200 cursor-pointer rounded-xl max-w-56 group' key={index}>
              <img className='transition-all duration-500 hover:translate-y-[-10px] bg-indigo-50 group-hover:bg-primary' src={item.image} alt="" />
              <div className='p-4'>
